...
using Com.Anqa.Service.Pos.Lib.Models.Discount;
...
using MongoDB.Bson;
using HashidsNet;
using Com.Anqa.Service.Pos.Lib.ViewModels.Discount;
using Com.Danliris.Service.Inventory.Lib.Helpers;
using static Com.Anqa.Service.Pos.Lib.ViewModels.Discount.DiscountViewModel;
...
namespace Com.Anqa.Service.Pos.Lib.Services.DiscountService
{
